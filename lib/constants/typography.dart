...
class AppTypography {
  static TextTheme getM3TextTheme([TextTheme? base]){
    return Typography.material2021(platform: TargetPlatform.android).black.merge(base ?? const TextTheme());
  }

  static TextStyle get pageTitle {
    return getM3TextTheme().headlineMedium!.copyWith(color: AppColors.secondary, fontWeight: FontWeight.w500);
  }
